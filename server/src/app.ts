...
import { router as adminRouter } from "./controllers/admin";
...
app.use("/api", adminRouter, commentRouter, apiRouter, authRouter, signInRouter, uploadRouter, downloadRouter);
